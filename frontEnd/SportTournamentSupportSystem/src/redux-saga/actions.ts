...
export const SWAP_TEAM_IN_BRACKET_RANK = 'SWAP_TEAM_IN_BRACKET_RANK';
export const EDIT_TOURNAMENT_INFO = 'EDIT_TOURNAMENT_INFO';
export const EDIT_USER_INFO = 'EDIT_USER_INFO';
export const USER_UPDATE_AVATAR = 'USER_UPDATE_AVATAR';
export const CHANGE_NOTE_BRACKET_RANK = 'CHANGE_NOTE_BRACKET_RANK';
...
export const UPDATE_MATCH_INFO_BEFORE_START = 'UPDATE_MATCH_INFO_BEFORE_START';
