...
export const REGIST_TEAM_SUCCESS = 'REGIST_TEAM_SUCCESS';
export const REGIST_TEAM_FAILED = 'REGIST_TEAM_FAILED';
...
export const REPORT_VIOLATION_FAILED = 'REPORT_VIOLATION_FAILED';
